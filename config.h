...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:sytle:medium:size=10", "Fira Code:style:medium:size=10", "Noto Color Emoji:size=11", "monospace:size=10" };
...
static const Rule rules[] = {
	...
	{ "zenity",           NULL,               NULL,                            0,         1,          1,        -1,      -1,  -1,  -1,  -1,   -1 },
};
